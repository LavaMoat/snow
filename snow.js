...
function resetOnloadAttributes(win, args, cb) {
  iterate(args, function (element) {
    var frames = getFramesArray(element, true);
    iterate(frames, function (frame) {
...
var map = securely(function () {
  return ArrayS.prototype.map;
});
